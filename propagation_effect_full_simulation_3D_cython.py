...
def find_ray_path_given_ini_cond(
    ...
    if ini_is_true == 1:
        ...
        is_true, full_ray_path = prop_tool_solve_int.ray_path(
            r0, theta0, phi0, theta_dash0, phi_dash0, R_A, n_p0, Bp, nu, mode, rho_fact, 10**6)
        # print(is_true)
        if is_true:
...
# l_R_A			=np.array([.1])
L = [64.0]#np.linspace(25., 30, 1)  # (1+l_R_A)*R_A
nu0 = 600.
dnu = 234 / 2.
